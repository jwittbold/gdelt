...
def unpacker(lst):
    ...
    Parameters: 
    lst (str): set to target_list variable which refers to value lists within suffix_dict.
    ...
    for target_url in Collector.target_list:  
        ...
        try:
            ...
            logging.exception(f'Encountered {e} while attempting to download {target_url}', exc_info=True)
